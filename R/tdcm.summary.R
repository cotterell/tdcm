...
#' probabilities, transition posterior probabilities, classifications, growth, growth effects,
...
#' \code{= 2} compares the first time point to every other time point.
#' \code{= 3} compares successive time points. Default = 1.
#'
#' @param classthreshold probability threshold for establishing proficiency from examinee
#' posterior probabilities. Default is .50, which maximizes overall classification accuracy.
#' It can be set to a lower value to minimize false negatives (i.e., misclassifying proficient
#' examinees as non-proficient) or set to a higher value to minimize false positives (i.e.,
#' misclassifying non-proficient examinees as proficient).
#'
