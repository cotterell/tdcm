...
* [`R-CMD-check.yaml`](https://github.com/cotterell/tdcm/blob/main/.github/workflows/R-CMD-check.yaml)
  runs `R-CMD-check` using the three major operating systems (linux, macOS and Windows) with the 
  current, development, and previous versions of R.
    
* [`pkgdown.yaml`](https://github.com/cotterell/tdcm/blob/main/.github/workflows/pkgdown.yaml) 
  builds the package website using `pkgdown::build_site_github_pages()`, then pushes the built 
  package website to GitHub Pages. The inclusion of
  ...
  - Release versions: [https://cotterell.github.io/tdcm/](https://cotterell.github.io/tdcm/)
  - Development versions: [https://cotterell.github.io/tdcm/dev/](https://cotterell.github.io/tdcm/dev/)
  
* [`pr-commands.yaml`](https://github.com/cotterell/tdcm/blob/main/.github/workflows/pr-commands.yaml) adds `/document` and `/style` commands for pull requests.

* [`test-coverage.yaml`](https://github.com/cotterell/tdcm/blob/main/.github/workflows/test-coverage.yaml) runs `covr::codecov()` on the package.
