...
author:
  - name: "Adriana Godamunne"
    email: "acg44605@uga.edu"
    affiliation: "School of Computing, University of Georgia"
  - name: "Kavya R. Kathiravan"
    email: "krk08454@uga.edu"
    affiliation: "School of Computing, University of Georgia"
  - name: "Braden Fuhriman"
    email: "bwf40867@uga.edu"
    affiliation: "School of Computing, University of Georgia"
  - name: "Connor J. Bell"
    email: "cjb42859@uga.edu"
    affiliation: "School of Computing, University of Georgia"
  - name: "Matthew J. Madison"
    email: "mjmadison@uga.edu"
    affiliation: "Department of Educational Psychology, University of Georgia"
...
tdcm_authors <- eval(str2expression(tdcm_pkg$'Authors@R'))
tdcm_maintainer <- as.person(tdcm_pkg$Maintainer)
tdcm_maintainer_name <- format(tdcm_maintainer, include = c("given", "family"))
tdcm_maintainer_email <- format(tdcm_maintainer, include = c("email"))
tdcm_maintainer_email <- stringr::str_replace_all(tdcm_maintainer_email, "^<|>$", "")
```
...
Do NOT modify the `DESCRIPTION` file unless you are either the
package maintainer or an existing author in `Authors@R`.
...
At the time of this writing, the package maintainer is 
**`r tdcm_maintainer_name`** based on the package's 
[`DESCRIPTION`](https://github.com/cotterell/tdcm/blob/main/DESCRIPTION) file.
